...
export const IconHandshake = (p: IconProps) => (
  <FaCategoryIcon {...p}>
    <path d="M96 208C96 199.2 103.2 192 112 192L160 192C168.8 192 176 199.2 176 208L176 432C176 440.8 168.8 448 160 448L112 448C103.2 448 96 440.8 96 432L96 208zM464 208C464 199.2 471.2 192 480 192L528 192C536.8 192 544 199.2 544 208L544 432C544 440.8 536.8 448 528 448L480 448C471.2 448 464 440.8 464 432L464 208zM208 256L256 256C264.8 256 273.6 258.4 281.4 263L320 286.2L358.6 263C366.4 258.4 375.2 256 384 256L432 256L432 296L400 296C394.5 296 389.1 297.5 384.3 300.4L324.3 336.4C321.6 338 318.4 338 315.7 336.4L255.7 300.4C250.9 297.5 245.5 296 240 296L208 296L208 256zM208 336L240 336C245.5 336 250.9 337.5 255.7 340.4L315.7 376.4C318.4 378 321.6 378 324.3 376.4L384.3 340.4C389.1 337.5 394.5 336 400 336L432 336L432 376L400 376C394.5 376 389.1 377.5 384.3 380.4L324.3 416.4C321.6 418 318.4 418 315.7 416.4L255.7 380.4C250.9 377.5 245.5 376 240 376L208 376L208 336z" />
  </FaCategoryIcon>
);
