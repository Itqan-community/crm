  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-2 py-2 space-y-1 overflow-y-auto">
        {items.map((it) => {
          const Icon = it.icon;
          // Exact match for hrefs that are themselves a prefix of another nav
          // item (root + settings root). Otherwise fall back to startsWith so
          // child URLs like /admin/submissions/abc keep the parent highlighted.
