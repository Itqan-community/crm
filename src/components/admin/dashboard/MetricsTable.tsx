    ...
    >
      <header style={{ marginBottom: 16 }}>
        <h2 style={{ margin: 0, fontSize: 16, fontWeight: 600, fontFamily: 'var(--font-display)' }}>
          مراجعة وتعديل الأرقام
        </h2>
        <p style={{ margin: '4px 0 0', fontSize: 12.5, color: 'var(--muted)' }}>
          كل صف يمثل قيمة يوم في الأسبوع الحالي (أحد إلى سبت). عدّل أي خانة واضغط حفظ — الرسوم البيانية فوق ستحدّث تلقائياً.
          أيام المستقبل غير متاحة للتحرير.
        </p>
      </header>
