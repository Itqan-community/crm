...
export const UI = {
  ...
  errPhone:         { ar: 'رقم الجوال غير صحيح. تحقّق من الرقم وحاول مجدداً.',
                      en: 'Invalid phone number. Please check and try again.' },
  errPhoneShort:    { ar: 'الرقم أقصر من المتوقّع — تأكّد من إدخاله كاملاً.',
                      en: 'The number is too short — please enter it in full.' },
  errPhoneLong:     { ar: 'الرقم أطول من المتوقّع — تحقّق من الأرقام المُدخَلة.',
                      en: 'The number is too long — please double-check the digits.' },
  errPhoneCountry:  { ar: 'تعذّر التعرّف على الدولة — اختر العَلَم المناسب أو أضِف رمز الدولة.',
                      en: 'Could not detect the country — pick the flag or include the country code.' },
